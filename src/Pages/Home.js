        ...
        <div className={styles.body}>
          ...
          <div className={styles.seconddiv}>
            ...
            <div className={styles.flex}>
              ...
              <Link to="/profile">
                <button className={styles.bigbutton}>
                  <i class="fa-solid fa-user" style={{ fontSize: "360%" }}></i>
                  <br /> <br /> Profile
                </button>
              </Link>
              <Link to="/fundaccount">
                <button className={styles.bigbutton}>
                  <i
                    ...
                    style={{ fontSize: "350%", color: "purple" }}
                  ></i>
                  <br /> <br /> Fund Account
                </button>
              </Link>
          ...
          <br />
          <div>
            <div className={styles.hi}>Hi, {allUsers[i].firstname}</div> <br />
            <div>
              <img className={styles.img} src="check.png" alt="" />
            </div>
          </div>
        </div>
        <br />
